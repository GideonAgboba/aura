...
type TextType = 'heading' | 'header' | 'sub-heading' | 'title' | 'normal' | 'small' | 'extra-small';
...
export const Text: React.FC<TextProps> = ({
  ...
  const typeStyleTag = as
    ? (Object.entries(typeToElement).find(([_, val]) => val === as)?.[0] as TextType)
    : type;
  ...
  return React.createElement(
    ...
    {
      ...props,
      className: clsx('text', styles.text, typeStyle, className,),
      'data-testid': testID,
    },
    children,
  );
